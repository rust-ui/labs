    ...
    view! {
        ...
        <div class="mainDiv m-0 py-8 flex flex-col items-center justify-center">
            <div class="container container__inline flex flex-col items-center justify-center flex-row">
                <div class="glass-container glass_container__rounded min-w-[32rem] relative flex m-2 rounded-[5rem] font-semibold text-white cursor-pointer bg-transparent overflow-hidden">
            ...
            <div class="container container__inline flex flex-col items-center justify-center flex-row">
                <div class="glass-container glass_container__rounded relative flex m-2 rounded-[5rem] font-semibold text-white cursor-pointer bg-transparent overflow-hidden">
                    ...
                    <div class="glass__content items-center gap-5 glass__content__alone relative z-30 flex px-6 pt-4 pb-4">
                        <div class="glass-item items-center justify-between text-center flex flex-col rounded-lg text-white">
            ...
            <div class="container flex flex-col items-center justify-center">
                <div class="glass-container relative flex rounded-2xl font-semibold text-white cursor-pointer bg-transparent overflow-hidden">
                    <div class="glass__filter absolute inset-0 z-0"></div>
                    <div class="glass__overlay absolute inset-0 z-10"></div>
                    <div class="glass__specular absolute inset-0 z-20 overflow-hidden"></div>
