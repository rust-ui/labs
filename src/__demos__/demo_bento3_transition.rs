...
pub fn DemoBento3Transition() -> impl IntoView {
    view! {
        ...
        <div class="mainDivParent text-[6.25vmax] max-lg:text-[60px] box-border">
          <div class="mainDiv text-[#222] bg-[#fff6de] text-[0.3rem] font-sans flex justify-center items-center min-h-screen">
            <div class="bento__grid__container gap-6 grid grid-cols-[2fr_1fr] grid-rows-[1fr_1fr] max-w-screen-md w-full aspect-[16/9]">
              ...
              />
              <label
                class="bento__grid__item bg-white/[0.33] rounded-[0.2rem] cursor-pointer bg-no-repeat bg-center bg-cover shadow-[0_0_12px_rgba(0,0,0,0.33)]"
                for="box-0"
                data-index="1"
